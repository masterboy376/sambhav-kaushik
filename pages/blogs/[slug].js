...
const Post = ({ blog }) => {
  ...
  const serializers = {
    ...
    link: (props) => <Link href={props}><a target='_black' style={{ lineHeight: "100%", textDecoration: "underline", color: `${darkMode ? 'rgb(20 184 166)' : 'rgb(147 51 234)'}`, textUnderlineOffset: "1px", fontWeight: '400' }} {...props} /></Link>,
    normal: (props) => <p style={{ paddingBottom: "10px" }} {...props} />,
    blockquote: (props) => <p style={{ padding: "10px", opacity: '70%' }} {...props} />,
            ...
            <div className={`relative z-10 min-h-screen w-full transition-all duration-300 ease-in-out ${darkMode ? 'text-teal-500' : 'text-purple-600'}`}>
              ...
              <div className="max-w-7xl w-full mx-auto">
                ...
                <main className='w-full min-h-screen transition-all duration-300 ease-in-out'>
                  ...
                  <div id='blog' className="w-full pt-10 mb-10 overflow-hidden flex flex-col min-h-screen px-10 container mx-auto">
                    ...
                    <div className="w-full my-2">
                      <div className={`p-4 rounded-2xl ${darkMode ? 'bg-gray-800' : 'bg-slate-100'}`}>
...
export async function getStaticProps(context) {
  let blog
  await client.fetch(`*[_type == "post" && slug.current=="${context.params.slug}"]{ title, slug, author->,'authorImg':author->image.asset->, 'mainImage':mainImage.asset->, categories[]->, body[]{
    ..., 
    asset->{
      ...,
      "_key": _id
    }
  }, metaData, _createdAt}`).then((rawBlog) => {
    blog = rawBlog
  })
  return {
